...
import { is_png, is_webp } from "../src/filetype.ts";

const data_png = new Uint8Array([
  ...
  0x59, 0x73, 0x00, 0x00, 0x05, 0x89, 0x00, 0x00, 0x05, 0x89, 0x01, 0x6d, 0x68,
  0x9d, 0xfa, 0x00, 0x00, 0x00, 0x01, 0x73, 0x52, 0x47, 0x42, 0x00, 0xae, 0xce,
  0x1c, 0xe9, 0x00, 0x00, 0x00, 0x04, 0x67, 0x41, 0x4d, 0x41, 0x00, 0x00, 0xb1,
  0x8f, 0x0b, 0xfc, 0x61, 0x05, 0x00, 0x00, 0x00, 0x17, 0x49, 0x44, 0x41, 0x54,
  0x78, 0x01, 0xed, 0xc0, 0x31, 0x01, 0x00, 0x00, 0x00, 0xc2, 0xa0, 0xf5, 0x4f,
  0xed, 0x61, 0x0d, 0x28, 0x80, 0x1b, 0x04, 0x10, 0x00, 0x01, 0xc5, 0xc8, 0x80,
  0x71, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4e, 0x44, 0xae, 0x42, 0x60, 0x82,
]);

const data_webp = new Uint8Array([
...
Deno.test("test is_png", () => {
  assertEquals(is_png(data_png), true);
});

Deno.test("test is_webp", () => {
  assertEquals(is_webp(data_png), false);
  assertEquals(is_webp(data_webp), true);
});
